export const ATL_PILLARS = [
  {
    ...
    items: [
      ...
      "Restaurationen",
      "Karosserieumbauten",
      "Glasreparatur und -erneuerung",
      "Smart Repair",
      "Sandstrahlen & Rostbeseitigung",
...
export const ATL_WHY = [
  {
    title: "Alles unter einem Dach",
    text: "Karosserie, Werkstatt und Tuning — ein Ansprechpartner, ein Qualitätsanspruch.",
  },
  {
    title: "Präzision statt Pfusch",
