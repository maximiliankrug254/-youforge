...
const steps = [
  {
    ...
    text: "Wir kommen zu Ihnen vor Ort, schauen uns alles in Ruhe an — unverbindlich und ohne Druck.",
  },
  {
    step: "02",
    title: "Transparentes Festpreisangebot",
    text: "Sie erhalten ein klares Angebot. Keine Nachforderungen, keine versteckten Kosten.",
  },
  {
    step: "03",
    title: "Termin & besenreine Übergabe",
    text: "Durchführung zum vereinbarten Termin — am Ende übergeben wir den Raum besenrein.",
  },
] as const;

export function RsProcess() {
  return (
    <section className="bg-[var(--rs-ink)] px-6 py-24 text-[var(--rs-cream)] sm:px-8 lg:py-32">
      <div className="mx-auto max-w-6xl">
        <RsReveal className="max-w-xl">
          ...
          <h2 className="mt-4 font-[family-name:var(--font-rs-display)] text-[clamp(1.85rem,4vw,2.75rem)] font-medium leading-tight tracking-[-0.02em]">
            In drei Schritten zum freien Raum
          </h2>
        </RsReveal>
